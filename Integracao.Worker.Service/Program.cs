...
using Integracao.MongoDB.Repository;
...
namespace Integracao.Worker.Service
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            try
            {
                Log.Information($"Starting {nameof(Integracao.Worker)}");
                ...
                Console.WriteLine($"Processo de Integracao - Ambiente: {ENV_NAME.ToUpper()}");
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    services.AddSingleton<ICollection1Repository, Collection1Repository>();
                    services.AddSingleton<ICollection2Repository, Collection2Repository>();
